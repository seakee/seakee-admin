        ...
        <el-card class="box-card" shadow="never">
            <div slot="header" class="clearfix">
                <div class="el-page-header">
                    ...
                    <div class="el-page-header__content">编辑菜单</div>
                </div>
            </div>
            <el-form :model="menuForm" :rules="rules" ref="menuForm" label-width="100px" status-icon>
                ...
                <el-form-item label="图标" prop="icon">
                    ...
                    <span>更多图标样式请参考<a style="color: #409EFF" href="https://fontawesome.com/icons?d=gallery&m=free"
                                      target="_blank">fontawesome.com</a></span>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="submitForm('menuForm')">立即更新</el-button>
...
<script>
    import {update, getInfo, getList} from "@/api/menu";
        ...
        methods: {
            ...
            fetchData(id) {
                getInfo(id).then(response => {
                    this.menuForm.father_id  = response.data.father_id;
                    this.menuForm.name       = response.data.name;
                    this.menuForm.route_name = response.data.route_name;
                    this.menuForm.icon       = response.data.icon;
                    this.menuForm.path       = response.data.path;
                    this.menuForm.sort       = response.data.sort;
                });
            }
        }
    }
